...
def gfunction(x, d):
     ...
     # ft = 1./(1.-alpha)*((1.+tl/t)**(1.-alpha)-(tl/t)**(1.-alpha))
     ft = 1.00
     D =D0*ft*(t0/t)**alpha*ke
...
EA=5000.00 #EA é a ativação de energia para a difusão de cloretos [J/mol]
R = 1.00 #R é a constante universal dos gases perfeitos [J·mol-1·K-1]
...
mediaD0 = 4.42*31536000.e-12 #coeficiente de difusão de cloretos em m2/anos
desvioD0 = 0.21*31536000.e-12
